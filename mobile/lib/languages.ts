// Whisper's ~99 supported transcription languages (ISO 639-1 codes + English names).
// Used for the first-launch language chooser. UI translation falls back to English for any
// language we haven't translated yet (see i18n.ts translations).
...
export const SUPPORTED_LANGUAGES: LangOption[] = [
  ...
  { code: "la", name: "Latin" }, { code: "lb", name: "Luxembourgish" }, { code: "ln", name: "Lingala" },
  { code: "lo", name: "Lao" }, { code: "lt", name: "Lithuanian" }, { code: "lv", name: "Latvian" },
  { code: "mg", name: "Malagasy" }, { code: "mk", name: "Macedonian" }, { code: "ml", name: "Malayalam" },
  { code: "mn", name: "Mongolian" }, { code: "mr", name: "Marathi" }, { code: "ms", name: "Malay" },
  { code: "mt", name: "Maltese" }, { code: "my", name: "Burmese" }, { code: "ne", name: "Nepali" },
